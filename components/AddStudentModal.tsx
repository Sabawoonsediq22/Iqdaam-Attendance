...
import type { InsertStudent } from "@/lib/schema";
...
export default function AddStudentModal({ cls, onSuccess, trigger }: AddStudentModalProps) {
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="max-w-[200px] sm:max-w-[300px] whitespace-normal word-break">
                        <p>The student ID is an optional unique identifier that can be used for additional student tracking and organization.</p>
                      </PopoverContent>
                    </Popover>
                  </div>
