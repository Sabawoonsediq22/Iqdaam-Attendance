...
async function seed() {
  ...
  const studentData = [
    ...
    {
      name: "Eve Wilson",
      fatherName: "Edward Wilson",
      studentId: "S005",
      email: "eve@example.com",
      gender: "Female",
      classId: insertedClasses[2].id,
    },
    {
      name: "Frank Miller",
      fatherName: "Francis Miller",
      studentId: "S006",
    ...
    },
    {
      ...
      gender: "Female",
      classId: insertedClasses[3].id,
    },
    {
      name: "Henry Davis",
      fatherName: "Harold Davis",
      studentId: "S008",
  ...
  const attendanceData = [
    ...
    {
      studentId: insertedStudents[4].id,
      classId: insertedClasses[2].id,
      date: todayString,
      day,
      month,
    ...
    {
      studentId: insertedStudents[5].id,
      classId: insertedClasses[2].id,
      date: todayString,
      day,
      month,
    ...
    {
      studentId: insertedStudents[6].id,
      classId: insertedClasses[3].id,
      date: todayString,
      day,
      month,
    ...
    {
      studentId: insertedStudents[7].id,
      classId: insertedClasses[3].id,
      date: todayString,
      day,
      month,
